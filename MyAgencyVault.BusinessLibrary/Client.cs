...
namespace MyAgencyVault.BusinessLibrary
{
    ...
    public class Client : IEditable<Client>
    {
        ...
        public static Client GetClient(Guid ClientId)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("GetClient:Exception occur while processing" + ex.Message, true);
               // throw ex;
        ...
        public static Guid AddUpdateClient(string clientName, Guid LicID, Guid ClientID)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("AddUpdateClient:Exception occurs while processing" + ex.Message, true);
               // throw ex;
            }
