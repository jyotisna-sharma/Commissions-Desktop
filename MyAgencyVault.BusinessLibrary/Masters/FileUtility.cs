...
namespace MyAgencyVault.BusinessLibrary.Masters
{
    ...
    public class FileUtility
    {
        ...
        {
            ActionLogger.Logger.WriteLog("Upload: " + localFilePath.ToString() , true);

            ActionLogger.Logger.WriteLog("Upload: " + remoteFilePath.ToString(), true);
        ...
        public void Upload(String localFilePath, String remoteFilePath, object state)
        {
            try
            {
               // ActionLogger.Logger.WriteLog("Upload internal 1: " + localFilePath, true);

              //  ActionLogger.Logger.WriteLog("Upload internal 2: " + remoteFilePath, true);
                FileInfo fileInfo = new FileInfo(localFilePath);
                long fileSize = fileInfo.Length;

                Uri uploadUri = getServerUrl(remoteFilePath, false);
             //   ActionLogger.Logger.WriteLog("Upload internal 3: " + uploadUri, true);
            ...
            {
                ActionLogger.Logger.WriteLog("Error uploading reprt: " + error.Message, true);
                if (ErrorOccured != null)
                    ErrorOccured(error);
            }
        }
        ...
        {
            ActionLogger.Logger.WriteLog("FinishUpload: " + result.IsCompleted, true);
            try
            {
                int statusCode = 0;
            ...
            {
                ActionLogger.Logger.WriteLog("FinishUpload error: " + error.Message, true);
                if(error.InnerException != null)
                    {
                    ActionLogger.Logger.WriteLog("FinishUpload error: " + error.InnerException.Message, true);
                }
                if (ErrorOccured != null)
                    ErrorOccured(error);
            }
        ...
        void HTTPRequest(Uri uri, string requestMethod, IDictionary<string, string> headers, byte[] content, string uploadFilePath, AsyncCallback callback, object state)
        {
            try
            {
                ...
                ActionLogger.Logger.WriteLog("httprequest 1: ", true);
                /*
                ...
                */
                ...
                {
                    ActionLogger.Logger.WriteLog("httprequest 11: ", true);
                ...
                {
                    ActionLogger.Logger.WriteLog("httprequest 12: ", true);
                ...
                ActionLogger.Logger.WriteLog("httprequest headers set: ", true);
                ...
                if (content != null || uploadFilePath != null)
                {
                    ...
                    if (content != null)
                    {
                        ActionLogger.Logger.WriteLog("httprequest headers 3: ", true);
                        // The request either contains actual content...
                    ...
                    {
                        ActionLogger.Logger.WriteLog("httprequest headers 4: " + uploadFilePath, true);
                        // ...or a reference to the file to be added as content.
                ...
                {
                    ActionLogger.Logger.WriteLog("httprequest headers 5: ", true);
            ...
            {
                ActionLogger.Logger.WriteLog("httprequest error: " + error.Message, true);
                if (ErrorOccured != null)
                    ErrorOccured(error);
            }
        }
