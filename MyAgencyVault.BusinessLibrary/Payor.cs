...
namespace MyAgencyVault.BusinessLibrary
{
    ...
    public class Payor
    {
        ...
        public static List<PayorObject> GetPayorsOnDate(DateTime dtStart, DateTime dtEnd)
        {
            ...
            try
            {
                ActionLogger.Logger.WriteLog("GetPayorsOnDate starts:  ", true);
                ...
                ActionLogger.Logger.WriteLog("GetPayorsOnDate - completed successfully, records - :  " + objList.Count, true);
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteLog("GetPayorsOnDate - exception:  " + ex.Message, true);
            }
            return objList;
        }
