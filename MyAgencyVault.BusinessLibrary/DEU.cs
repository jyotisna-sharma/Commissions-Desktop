...
namespace MyAgencyVault.BusinessLibrary
{
    ...
    public class DEU
    {
        ...
        public static DEU GetDEULatestInvoiceDateRecord(Guid DeuID)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("GetDEULatestInvoiceDateRecord :" + ex.StackTrace.ToStringDump(), true);
                if (ex.InnerException != null)
                {
                    ActionLogger.Logger.WriteLog("GetDEULatestInvoiceDateRecord :" + ex.InnerException.Message, true);
                }
               // throw ex;
            }
            return _DEU;
        ...
        public void AddupdateDeuEntry(DEU _DeuEntry)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("issue in AddupdateDeuEntry:" + ex.StackTrace.ToStringDump(), true);
                if (ex.InnerException != null)
                {
                    ActionLogger.Logger.WriteLog("issue in AddupdateDeuEntry:" + ex.InnerException.ToStringDump(), true);
                }
               // throw ex;
            }
        }
        ...
        public ModifiyableBatchStatementData AddUpdate(DEUFields deuFields, Guid oldDeuEntryID)
        {
                ...
                using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
                {
                    ...
                    foreach (DataEntryField field in deuFields.DeuFieldDataCollection)
                    {
                        switch (field.DeuFieldName)
                        {
                            ...
                            case "CompType":
                                ActionLogger.Logger.WriteLog("CompType in deuaddupdate: " + field.DeuFieldValue, true);
            ...
            catch (Exception ex)
            {
                ...
                ActionLogger.Logger.WriteLog("Issue in AddUpdate Message " + ex.Message.ToString(), true);
        ...
        public static DEU GetDeuEntrytDateRecord(Guid deuStatementD)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("GetDeuEntrytDateRecord " + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("GetDeuEntrytDateRecord " + ex.Message.ToString(), true);
                ActionLogger.Logger.WriteLog("GetDeuEntrytDateRecord " + ex.InnerException.ToString(), true);
            }
        ...
        public static void UpdateTotalAmountAndEntry(Guid deuStatementD, Guid DeuEntryId)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("UpdateTotalAmountAndEntry ex.StackTrace :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("UpdateTotalAmountAndEntry ex.Message:" + ex.Message.ToString(), true);
                //throw ex;
            }
        ...
        public void DeleteDeuEntryByID(Guid _DeuEntryID)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("DeleteDeuEntryByID : " + ex.Message, true);
        ...
        public ExposedDEU CreateExposedDEU(DLinq.EntriesByDEU deu)
        {
            ...
            try
            {
                ...
                {
                    ActionLogger.Logger.WriteLog("CreateExposedDEU: no payment entry for the DEU entry, flag false ", true);
                    exposedDeu.IsPaymentFailure = true;
                }
...

      {
        ...
        public static List<DataEntryField> GetDeuFields(Guid DeuEntryID)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("GetDeuFields " + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("GetDeuFields " + ex.InnerException.ToString(), true);
            }
            return deuFields;
        }
        ...
        {
            ActionLogger.Logger.WriteLog("GetDeuEntryidWise:process begins for DeuEntryId: " + DeuEntryID, true);
            ...
            {
                ActionLogger.Logger.WriteLog("GetDeuEntryidWise exception :" + ex.StackTrace.ToStringDump(), true);
                if (ex.InnerException != null)
                {
                    ActionLogger.Logger.WriteLog("GetDeuEntryidWise Inner exception :" + ex.InnerException.Message, true);
                }
                //throw ex;
            }
