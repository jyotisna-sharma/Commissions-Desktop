...
namespace MyAgencyVault.BusinessLibrary
{
    public class AESEncrypt
    {
        ...
        public static string GetEncryptedString(string plainText)
        {
            ...
            byte[] encryptText = EncryptStringToBytes_Aes(plainText, Encoding.UTF8.GetBytes(key), Encoding.UTF8.GetBytes(iv));

            string strPassword = Convert.ToBase64String(encryptText);
            return strPassword;
        }
